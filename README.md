...
[Example](https://github.com/nufeng1999/jupyter-MyVBScript-kernel/blob/master/example/jupyter_MyVBScript_readme.ipynb "Example")
...
cd jupyter_MyVBScript_kernel && install_MyVBScript_kernel --user
